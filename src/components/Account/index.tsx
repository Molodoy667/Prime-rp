  ...
  if (player) return (
    <div className="account-page">
      ...
      <main className="account-main">
        ...
        {player.role === 'admin' && <section className="account-admin-panel"><div><p className="eyebrow"><span/> ADMIN CONTROL</p><h2>ПАНЕЛЬ АДМІНІСТРАТОРА</h2><p>Розділ доступний лише профілям із роллю адміністратора. Тут буде зібрано керування ролями та доступом до кабінету.</p></div><div className="account-admin-roles"><div><strong>ADMIN</strong><span>повний доступ</span></div><div><strong>MODERATOR</strong><span>модерація</span></div><div><strong>USER</strong><span>базовий доступ</span></div></div></section>}
